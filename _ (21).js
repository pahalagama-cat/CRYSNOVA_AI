...
// 3. Detect if any AFK user is mentioned/quoted – mirrors OWNER MENTION HANDLER pattern
function isAfkUserMentioned(m, mek, sock) {
    ...
    // ─── 2. TEXT CONTENT (built once, reused per AFK user) ───
    const allText = [
        rawMsg.conversation,
    ...
    // ─── 3. CHECK EACH AFK USER IN THIS CHAT ───
