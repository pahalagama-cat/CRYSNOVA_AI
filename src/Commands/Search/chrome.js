...
module.exports = {
    ...
    execute: async (sock, m, { args, reply }) => {
        ...
        try {
            ...
            // Custom sourceUrl so WhatsApp can't override thumbnail with its own preview
            const sourceUrl = `https://crysnova.ai/search?q=${encodeURIComponent(query)}&t=${Date.now()}`;
